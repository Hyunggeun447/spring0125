...
class MemberRepositoryTest {
    ...
    public void basic() throws Exception {
        ...
        Member findByIdMember = memberRepository.findById(member.getId()).get();
        ...
        List<Member> findByUsernameMember = memberRepository.findByUsername("member");
        assertThat(findByUsernameMember).containsExactly(member);

        /*// ============================ DSL 버전 ================================
        List<Member> findAllMemberDsl = memberRepository.findAllDsl();
        assertThat(findAllMemberDsl).containsExactly(member);

        List<Member> findByUsernameMemberDsl = memberRepository.findByUsernameDsl("member");
